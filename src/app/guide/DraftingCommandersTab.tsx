    ...
    <>
      ...
      <Accordion defaultExpanded>
        <AccordionSummary expandIcon={<ExpandMoreIcon />}>
          <Typography variant="h6">Option 1: partners or backgrounds</Typography>
        </AccordionSummary>
        <AccordionDetails>
          <Typography variant="body1" color="text.secondary" gutterBottom>
          ...
          <Typography variant="body2" color="text.secondary">Pros:</Typography>
          ...
          <Typography variant="body2" color="text.secondary">Cons:</Typography>
      ...
      <Accordion>
        ...
        <AccordionDetails>
          ...
          <Typography variant="body1" color="text.secondary" gutterBottom>
            ...
            but the number of options across the full spectrum of power levels is
            much bigger.
          </Typography>
          <Typography variant="body1" color="text.secondary" gutterBottom>
      ...
      <Typography variant="body1" color="text.secondary">
        ...
        consequences for your complexity, power level, mechanics and flavour. You
        will have to choose the option that&apos;s best for you, or perhaps more
        importantly: your players!
      </Typography>
    </>
  );
}
